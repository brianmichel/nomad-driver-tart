...
func (d *Driver) TaskStats(ctx context.Context, taskID string, interval time.Duration) (<-chan *drivers.TaskResourceUsage, error) {
	...
	go d.collectStats(ctx, h, interval, ch)
	return ch, nil
}
...
// collectStats periodically emits resource usage statistics for the VM task. It
// aggregates stats from the tart process as well as the associated
